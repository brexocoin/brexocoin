...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid brexocoin address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid brexocoin address" in e.error['message'])
