...
This mechanism has been integrated into Bitcore-Node-Brexocoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/brexocoinpay/insight-api-brexocoin#web-socket-api](https://github.com/brexocoinpay/insight-api-brexocoin#web-socket-api)
* API: [https://github.com/brexocoinpay/insight-api-brexocoin#instantsend-transactions](https://github.com/brexocoinpay/insight-api-brexocoin#instantsend-transactions)
...
By default, the Brexocoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Brexocoin Core daemon:
