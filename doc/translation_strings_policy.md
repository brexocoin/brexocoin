...
This document provides guidelines for internationalization of the Brexocoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `brexocoin_en.ts` remains unchanged.
