/* src/config/brexocoin-config.h.  Generated from brexocoin-config.h.in by configure.  */
/* src/config/brexocoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef BREXO_CONFIG_H

#define BREXO_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Brexocoin Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Brexocoin Core"
...
#define PACKAGE_BUGREPORT "https://github.com/brexocoinpay/brexocoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Brexocoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Brexocoin Core 0.12.3"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "brexocoincore"

/* Define to the home page for this package. */
#define PACKAGE_URL "http://brexocoin.com/"
