...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print Brexocoin address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "brexocoin",               "masternode",             &masternode,             true,  {} },
    { "brexocoin",               "masternodelist",         &masternodelist,         true,  {} },
    { "brexocoin",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "brexocoin",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "brexocoin",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "brexocoin",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
