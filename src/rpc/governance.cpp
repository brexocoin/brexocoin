...
UniValue gobject(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp  ||
        ...
        throw std::runtime_error(
                ...
                "  vote-conf          - Vote on a governance object by masternode configured in brexocoin.conf\n"
    ...
    */
    ...
    if(strCommand == "vote-conf")
    {
        ...
        if(!fMnFound) {
            ...
            resultsObj.push_back(Pair("brexocoin.conf", statusObj));
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    /* Brexocoin features */
    { "brexocoin",               "getgovernanceinfo",      &getgovernanceinfo,      true,  {} },
    { "brexocoin",               "getsuperblockbudget",    &getsuperblockbudget,    true,  {"index"} },
    { "brexocoin",               "gobject",                &gobject,                true,  {} },
    { "brexocoin",               "voteraw",                &voteraw,                true,  {} },
