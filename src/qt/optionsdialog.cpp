    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("BREXO-light"), QVariant("light"));
    ui->theme->addItem(QString("BREXO-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("BREXO-light-retro"), QVariant("light-retro"));
    ui->theme->addItem(QString("BREXO-light-hires-retro"), QVariant("light-hires-retro"));
    ui->theme->addItem(QString("BREXO-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("BREXO-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("BREXO-traditional"), QVariant("trad"));
