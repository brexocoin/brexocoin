    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  brexocoin-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Brexocoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 BREXO, 0.1 BREXO, 1 BREXO and 10 BREXO -- sort of like the paper money you use every day.</li> \
